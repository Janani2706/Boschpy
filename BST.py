...
print("Search 6:", bst.search(6))   # False
 
print("Inorder traversal:", bst.inorder())     # [3, 5, 7, 10, 12, 15, 18]
print("Preorder traversal:", bst.preorder())   # [10, 5, 3, 7, 15, 12, 18]
print("Postorder traversal:", bst.postorder()) # [3, 7, 5, 12, 18, 15, 10]