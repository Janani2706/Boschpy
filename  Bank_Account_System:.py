...
if __name__ == "__main__":
    ...
    savings_username = input("Enter savings acc_holder name: ")
    savings_account_number = input("Enter savings account number: ")
    savings = SavingsAccount(savings_username, savings_account_number, 2)
    print(savings.account_details())
    print(savings.deposit(500))
    print(savings.apply_interest())
    print(savings.show_balance())
 
    current_username = input("Enter current acc_holder name: ")
